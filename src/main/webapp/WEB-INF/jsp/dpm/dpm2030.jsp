    ...
    <div class="info-container">
        <div class="data-container">
            <div class="subtitle2-container">
                <img src="../images/icon-arrow-point.png" alt="이력조회" > <span class="subtitle2">일별 처리현황</span>
            </div>
            <form id="frm2030" role="form"  method="post">                    
	            <div class="search-box">                        
	            <div class="guide-text float-left">처리일자</div>
	            <div class="float-left">
	                <div class="form group">
	                    <div class="input-group date">
	                        <input id="txtStartDt" name="startBasDt" type="text" class="form-control "  style="width:130px; margin-right: 0px; padding-right:30px;" maxlength="10" >                     
	            ...
	            <div class="float-left">
	                <div class="form group">
	                    <div class="input-group date">
	                        <input id="txtEndDt" name="endBasDt" type="text" class="form-control " style="width:130px; margin-right: 5px; padding-right:30px;" maxlength="10" >
     ...
     <!-- content페이지 end-->
    <script type="text/javascript" src="/js/dpm/dpm2030.js"></script>
</body>
</html>