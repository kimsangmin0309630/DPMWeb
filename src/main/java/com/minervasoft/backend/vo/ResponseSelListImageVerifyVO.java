...
public class ResponseSelListImageVerifyVO extends AbstractResponseVO {
	...
	private List<ImageVerifyVO> selList = null;
	...
	public List<ImageVerifyVO> getSelList() {
		return selList;
	}

	public void setSelList(List<ImageVerifyVO> selList) {
